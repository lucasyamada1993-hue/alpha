...
const DADOS_COLABORADORES = [
  {
    id: 1,
    nome: "Dra. Paula Teixeira",
    pdi15: { alcancou: 90, naoAlcancou: 10 },
    pdi30: { alcancou: 88, naoAlcancou: 12 },
    pdi60: { alcancou: 85, naoAlcancou: 15 },
    pdi90: { alcancou: 92, naoAlcancou: 8 },
  },
  {
    id: 2,
    nome: "Enfermeiro João Silva",
    pdi15: { alcancou: 80, naoAlcancou: 20 },
    pdi30: { alcancou: 78, naoAlcancou: 22 },
    pdi60: { alcancou: 75, naoAlcancou: 25 },
    pdi90: { alcancou: 82, naoAlcancou: 18 },
  },
  {
    id: 3,
    nome: "Enfermeira Maria Santos",
    pdi15: { alcancou: 87, naoAlcancou: 13 },
    pdi30: { alcancou: 84, naoAlcancou: 16 },
    pdi60: { alcancou: 81, naoAlcancou: 19 },
    pdi90: { alcancou: 88, naoAlcancou: 12 },
  },
  {
    id: 4,
    nome: "Enfermeiro Pedro Oliveira",
    pdi15: { alcancou: 78, naoAlcancou: 22 },
    pdi30: { alcancou: 76, naoAlcancou: 24 },
    pdi60: { alcancou: 73, naoAlcancou: 27 },
    pdi90: { alcancou: 80, naoAlcancou: 20 },
  },
];

export default function EstatisticasEnfermeiro() {
  ...
  return (
    <div className="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden">
      ...
      <div className="px-6 py-5 border-b border-gray-100">
        <h3 className="font-semibold text-gray-800">Estatísticas de PDI — Enfermeiro(a)</h3>
      </div>
