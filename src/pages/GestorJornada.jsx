...
// ── Página Principal ───────────────────────────────────────────────────────
export default function GestorJornada() {
    ...
    <div className="space-y-5">
      ...
      <div className="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden">
        ...
        <div className="px-5 py-4 border-b border-gray-100 flex items-center justify-between gap-4 flex-wrap">
          <div>
            <h2 className="font-bold text-gray-800 text-sm">Rastreabilidade da Jornada em Tempo Real</h2>
            <p className="text-xs text-gray-400 mt-0.5">Recepção → Preparo → Sala → Laudo</p>
          </div>
        ...
        <div className="px-5 py-3 bg-gray-50 border-t border-gray-100 flex items-center justify-between">
          ...
          <button className="text-[11px] text-blue-600 font-semibold hover:text-blue-800 transition-colors">
            Ver todos →
          </button>
        </div>
      </div>
